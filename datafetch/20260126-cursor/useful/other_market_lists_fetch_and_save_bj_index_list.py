"""
独立接口程序：获取并存储京市指数列表数据。

本程序为 other_market_lists_sync.py 中京市指数列表接口的独立版本，可独立运行。
支持与其他接口程序并发运行。

API接口: fetch_and_save_bj_index_list
"""
...
logger = get_logger("format.other_market_lists_fetch_and_save_bj_index_list")


def main() -> None:
    """
    主函数：调用京市指数列表接口获取并存储数据。
