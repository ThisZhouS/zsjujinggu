"""
独立接口程序：获取并存储十大流通股东数据。

本程序为 shareholder_detailed_data_sync.py 中十大流通股东接口的独立版本，可独立运行。
支持与其他接口程序并发运行。
...
logger = get_logger("format.shareholder_detailed_data_fetch_and_save_top10_float_shareholders")
