"""
辅助程序：在固定时间区间内获取并存储资金流向数据。

本程序基于 `format.trading_details_special_data_fetch_and_save_money_flow`，
仅修改时间参数为固定范围：
...
logger = get_logger(
    "useful.trading_details_special_data_fetch_and_save_money_flow",
)
