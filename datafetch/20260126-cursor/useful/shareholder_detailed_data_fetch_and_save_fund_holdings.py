...
本程序为 shareholder_detailed_data_sync.py 中基金持股接口的独立版本，可独立运行。
支持与其他接口程序并发运行。
...
logger = get_logger("format.shareholder_detailed_data_fetch_and_save_fund_holdings")
