"""
独立接口程序：获取并存储公司十大流通股东数据。

本程序为 shareholder_basic_info_sync.py 中公司十大流通股东接口的独立版本，可独立运行。
支持与其他接口程序并发运行。
...
logger = get_logger("format.shareholder_basic_info_fetch_and_save_company_top_flow_holders")
...
def main() -> None:
    ...
    logger.info("公司十大流通股东累计写入记录数: {}", total)
