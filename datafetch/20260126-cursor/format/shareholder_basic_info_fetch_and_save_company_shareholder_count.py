...
本程序为 shareholder_basic_info_sync.py 中公司股东数接口的独立版本，可独立运行。
支持与其他接口程序并发运行。
...
logger = get_logger("format.shareholder_basic_info_fetch_and_save_company_shareholder_count")
