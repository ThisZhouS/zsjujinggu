...
本程序为 major_market_lists_sync.py 中股票列表接口的独立版本，可独立运行。
支持与其他接口程序并发运行。

API接口: fetch_and_save_stock_list
"""
...
logger = get_logger("format.major_market_lists_fetch_and_save_stock_list")
